...
predictor = dlib.shape_predictor(
    '/Users/ayang/PycharmProjects/pythonProject/shape_predictor_68_face_landmarks.dat')
...
while True:
    ...
    for rect in rects:
        ...
        cv2.putText(frame, "now: {}".format(now), (300, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
